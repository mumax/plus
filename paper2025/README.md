...
* The data from Fig. 2 is generated with [AFM_mobility.py](https://github.com/mumax/plus/tree/paper2025/paper2025/AFM_mobility.py).
* The data from Fig. 3 is generated with [AFM_racetrack.py](https://github.com/mumax/plus/tree/paper2025/paper2025/AFM_racetrack.py).
* The data from Fig. 4 is generated with [NcAfm_NV.py](https://github.com/mumax/plus/tree/paper2025/paper2025/NcAfm_NV.py).