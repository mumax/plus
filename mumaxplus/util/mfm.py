...
from mumaxplus import FieldQuantity, Grid, Magnet, World
...
class MFM(FieldQuantity):
    ...
    def __init__(self, input: World | Magnet, grid: Grid):
        ...
        Parameters
        ----------
        input : can be either a :class:`mumaxplus.World` or :class:`mumaxplus.Magnet`
                instance. If it is a World, all magnets in that world will be used to
                calculate the potential energy at the tip.
